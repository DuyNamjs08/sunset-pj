              ...
              <div className="site-about__content">
                <div className="title">
                  <span className="title__slogan">
                    NĂNG LƯỢNG XANH CHO TRIỆU MÁI NHÀ VIỆT
                  </span>
                  <h2 className="title__heading" />
                </div>
                <div className="site-about__images mb-3">
                  <img
                ...
                <div className="des the_content">
                  ...
                  <p style={{ textAlign: "justify" }}>
                    ...
                    2012, thời điểm khái niệm{" "}
                    <a href="https://vi.wikipedia.org/wiki/%C4%90i%E1%BB%87n_m%E1%BA%B7t_tr%E1%BB%9Di">
                      Điện Mặt Trời
                    </a>{" "}
                    và{" "}
                    <a href="https://vi.wikipedia.org/wiki/N%C4%83ng_l%C6%B0%E1%BB%A3ng_t%C3%A1i_t%E1%BA%A1o#:~:text=N%C4%83ng%20l%C6%B0%E1%BB%A3ng%20t%C3%A1i%20t%E1%BA%A1o%20hay,%2C%20s%C3%B3ng%20v%C3%A0%20%C4%91%E1%BB%8Ba%20nhi%E1%BB%87t..">
                      Năng lượng tái tạo
                    </a>{" "}
                    đặt chân đến Việt Nam. Mục tiêu của những thành viên sáng
                    lập ban đầu là cố gắng mang tới cho người Việt những công
                    nghệ mới nhất trên thế giới về năng lượng sạch từ điện mặt
                    trời. Mong muốn nguồn năng lượng tái tạo của tương lai sẽ
                    thay thế được phần nào Nhiệt điện, Thủy Điện… và những nguồn
                    năng lượng hóa thạch đang dần cạn kiệt gây hủy hoại môi
                    trường sống tương lai của con người.
                  </p>
                  <p style={{ textAlign: "justify" }}>
                  ...
                  <p style={{ textAlign: "justify" }}>
                    ...
                    ngôi nhà mới xây của mỗi chủ nhà hiện đại, giống như lắp một
                    chiếc điều hòa hay mua một chiếc tivi tốt. Vì vậy, cân nhắc
                    lựa chọn một sản phẩm điện mặt trời Uy tín, đáng tin cậy để
                    trang bị cho ngôi nhà của mình luôn là nỗi băn khoăn của
                    từng Chủ đầu tư, từng khách hàng trước vô vàn thông tin khác
                    nhau về sản phẩm, về thiết bị Điện mặt trời trên thị trường.
                  </p>
                  <p style={{ textAlign: "justify" }}>
                    Mỗi thiết bị với một nhà sản xuất khác nhau (tấm pin thương
                    hiệu A, Inverter thương hiệu B, đội lắp đặt không chuyên
                    thương hiệu C…) khiến cho việc bảo hành, chăm sóc sản phẩm
                    sau bán hàng cho khách hàng vô cùng khó khăn và trở nên mông
                    lung hơn lúc nào hết.
                  </p>
                  <p style={{ textAlign: "justify" }}>
                  ...
                  <p style={{ textAlign: "justify" }}>
                    ...
                    >
                      Đội ngũ nhân sự giàu kinh nghiệm của chúng tôi đã thi công
                      rất nhiều công trình với đa dạng phong cách kiến trúc và
                  ...
                  <ul style={{ textAlign: "justify" }}>
                    <li style={{ fontWeight: 400 }} aria-level={1}>
                      <i>
                        <span style={{ fontWeight: 400 }}>Tầm nhìn:</span>
                      </i>
                    </li>
                  </ul>
                  <p style={{ textAlign: "justify" }}>
                    ...
                    <span style={{ fontWeight: 400 }}>
                      {" "}
                      chúng tôi kỳ vọng sẽ ngày càng phát triển góp phần nâng
                      cao chất lượng đời sống của người Việt bằng nguồn năng
                      lượng sạch – an toàn – tiết kiệm.
                    </span>
                    <i />
                  </p>
                  <ul style={{ textAlign: "justify" }}>
                    <li style={{ fontWeight: 400 }} aria-level={1}>
                      <i>
                        <span style={{ fontWeight: 400 }}>Sứ mệnh:</span>
                      </i>
                    </li>
                  </ul>
                  <p style={{ textAlign: "justify" }}>
                  ...
                  <p style={{ textAlign: "justify" }}>
                    <span style={{ fontWeight: 400 }}>
                      Với tất cả niềm đam mê, sự tận tâm và những giải pháp
                      thông minh chúng tôi luôn sát cánh cùng Quý khách hàng và
                      các đối tác kinh doanh để tập trung tạo ra lợi ích lâu dài
                      và bền vững.
                    </span>
                  </p>
                  <p style={{ textAlign: "justify" }}>
                ...
                <div className="site-about__images">
                  <a
                    data-fancybox
                    className="play-video m-0 justify-content-start"
                    href="https://youtube.com/channel/UCtCvtvsPm95i9EhYmpPB_aw"
                  >
                    <span className="play">
                      <FaPlay />
                    </span>
...
const GioiThieu2Style = styled.div`
  .site-about {
  ...
  .site-about__images .play-video span {
    font-size: 13px;
    text-transform: uppercase;
    color: #2b3152;
    padding-left: 10px;
