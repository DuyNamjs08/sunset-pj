...
export const headerLinks = [
  ...
  { text: "Giới thiệu", url: "/cong-ty-dien-mat-troi-uy-tin/" },
  {
    ...
    url: "/san-pham/",
    subMenu: [
      { text: "Tấm pin mặt trời", url: "/tam-pin-mat-troi/" },
      { text: "Inverter hòa lưới", url: "/inverter-hoa-luoi-dien-mat-troi/" },
      { text: "Hệ thống điện mặt trời", url: "/he-thong-dien-mat-troi/" },
      {
        text: "Phụ kiện Điện mặt trời",
        url: "/vat-tu-phu-kien-dien-mat-troi/",
      },
      {
        text: "Bộ lưu trữ điện năng lượng mặt trời",
        url: "/bo-luu-tru-dien-nang-luong-mat-troi/",
      },
    ],
  },
  {
